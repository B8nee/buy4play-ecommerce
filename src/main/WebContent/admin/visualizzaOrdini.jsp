...
<html>
    <head>
        ...
        <style>
            /* Stili per la pagina di amministrazione degli ordini */
            .admin-container {
    ...
    <div class="admin-container">
        ...
        <!-- Form per i filtri (data da, data a, email cliente, stato) -->
        ...
        <!-- Tabella degli ordini con tutte le colonne e azioni -->
                ...
                <tbody>
                    <%
                        ...
                        if (ordini != null && !ordini.isEmpty()) {
                            for (Ordine o : ordini) {
                                // Determina la classe CSS per il badge dello stato
                                String statoClasse = "";
    ...
    <script>
        // Funzione per aggiornare lo stato di un ordine via AJAX (POST)
        function updateStatus(orderId) {
            ...
            .then(data => {
                if (data.success) {
                    location.reload();   // Ricarica la pagina per riflettere il cambiamento
                } else {
        ...
        // Gestione eliminazione ordine con conferma e AJAX

...
<html>
    <head>
        <meta charset="UTF-8">
        <title>500 - Errore interno | Buy4Play</title>
        <style>
            /* Reset e stili per la pagina di errore 500 (tema scuro coerente con il sito) */
            * {
                margin: 0;
                padding: 0;
    ...
    <body>
        <div class="error-container">
            <!-- Icona descrittiva per errore generico del server -->
            <div class="icon">⚠️</div>
            <div class="error-code">500</div>
            <h1>Errore interno del server</h1>
            <p>Si è verificato un problema imprevisto. Ci scusiamo per il disagio.</p>

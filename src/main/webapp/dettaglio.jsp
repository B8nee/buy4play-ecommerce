<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    <%@ include file="header.jsp" %>
        <%@ page import="model.Prodotto" %>
            <% Prodotto p=(Prodotto) request.getAttribute("prodotto"); if (p==null) { response.sendRedirect("catalogo");
                return; } %>
                <div style="max-width: 600px; margin: 0 auto; background: white; padding: 2rem; border-radius: 12px;">
                    ...
                    <p><strong>Piattaforma:</strong>
                        <%= p.getPiattaforma() %>
                    </p>
                    <p><strong>Prezzo:</strong> &euro; <%= String.format("%.2f", p.getPrezzo()) %>
                    </p>

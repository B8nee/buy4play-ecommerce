...
<form method="get" action="visualizzaOrdini">
    Data da: <input type="date" name="dataInizio" value="<%= request.getParameter("dataInizio") != null ? request.getParameter("dataInizio") : "" %>">
    Data a: <input type="date" name="dataFine" value="<%= request.getParameter("dataFine") != null ? request.getParameter("dataFine") : "" %>">
    Cliente ID: <input type="text" name="clienteId" value="<%= request.getParameter("clienteId") != null ? request.getParameter("clienteId") : "" %>">
    <input type="submit" value="Filtra">
</form>
<table border="1">
    <tr><th>ID Ordine</th><th>Cliente ID</th><th>Data</th><th>Totale</th><th>Dettaglio</th></tr>
<%

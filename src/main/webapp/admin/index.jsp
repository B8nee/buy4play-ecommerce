...
<head>
    ...
    <style>
        ...
        .card { border: 1px solid #ccc; padding: 20px; border-radius: 8px; width: 200px; text-align: center; }
        .card a { text-decoration: none; font-weight: bold; }
    </style>
</head>
<body>
    <h1>Area Amministrazione - Benvenuto, <%= admin.getNome() %></h1>
    <div class="dashboard">
        <div class="card">
            <h3>📦 Prodotti</h3>
        ...
        <div class="card">
            <h3>👥 Utenti</h3>
            <a href="gestioneUtenti.jsp">Gestisci utenti</a>
        </div>
    </div>
    <p><a href="<%= request.getContextPath() %>/catalogo">← Torna al sito</a> | <a href="<%= request.getContextPath() %>/logout">Logout</a></p>
</body>
</html>
...
<table border="1">
    <tr><th>ID</th><th>Nome</th><th>Piattaforma</th><th>Prezzo</th><th>Azioni</th></tr>
<%
...
%>
    <tr>
        ...
        <td>
            ...
            <a href="gestioneProdotti?action=delete&id=<%= p.getId() %>" onclick="return confirm('Confermi eliminazione?')">Cancella</a>
        </td>
    </tr>
<%
        }
